...
class TutorialOverlay(QtWidgets.QWidget):
    ...
    def highlight_widget_area(self, widget):
        ...
        Args:
            widget (QtWidgets.QWidget): The widget to highlight. If None, removes highlighting.
        """
        if widget and self.parent():
            ...
            # Clear highlighting if no widget provided
...
class TutorialManager:
        ...
        self.tutorial_steps = [
            {
                ...
                "highlight_widget": None  # No specific widget to highlight
            },
            {
            ...
            },
            {
                ...
                "highlight_widget": "add_btn"  # Highlight add button
            },
            {
            ...
            },
            {
                ...
                "content": "The map shows your HQ (green), delivery stops (red), and optimized routes. You can zoom, pan, and click on markers for more information. Different algorithms show routes in different colors.",
    ...
    def _show_tutorial_step(self):
        ...
        # Highlight the relevant UI widget for this step
        widget_name = step_info.get("highlight_widget")
        if widget_name and hasattr(self.main_window, widget_name):
            widget = getattr(self.main_window, widget_name)
            self.overlay.highlight_widget_area(widget)
        else:
            # No specific widget to highlight, clear highlighting
...
class PlannerUI(QtWidgets.QMainWindow):
    ...
    def _setup_ui(self):
        ...
        # Display initial blank map
        self._display_blank_map()
        
        # Initialize with default number of stops
    ...
    def _setup_table_buttons(self, layout: QtWidgets.QVBoxLayout):
        ...
        self.btn_add.clicked.connect(self._add_delivery_point)
    ...
    def _get_coordinates(self) -> Optional[List[Tuple[float, float]]]:
        """
        Get all coordinates (HQ + delivery points) from the UI.
        
        Returns:
            List of (lat, lon) tuples starting with HQ, or None if invalid data
        """
        try:
            # Start with HQ coordinates
            coords = [HQ_COORD]
    ...
    def _show_about_dialog(self):
        ...
        QtWidgets.QMessageBox.about(
            ...
            "About Route Planner",
            """
            <h3>Delivery Route Planner</h3>
            <p>Version 1.0</p>
            <p>A PyQt5-based application for optimizing delivery routes using graph-based algorithms.</p>
            <p><b>Features:</b></p>
            <ul>
                <li>Interactive GUI with embedded map visualization</li>
                <li>Multiple optimization algorithms (Held-Karp & Christofides)</li>
                <li>Real-world road network routing</li>
                <li>Performance comparison tools</li>
                <li>Comprehensive help system</li>
            </ul>
            <p><b>Algorithms:</b> Held-Karp (exact solution), Christofides (approximation)</p>
            <p><b>Built with:</b> PyQt5, Folium, OSMnx, NetworkX</p>
            """
        )
